...
export function MATCH_QUERY_GRAPHQL(matchId) {
    return `
    {
      match(id: ${matchId}) {
        id
...
export function VERIFYING_PLAYER_GRAPHQL(steamAccountId) {
    return `
    {
...
export function PLAYERS_LASTMATCH_GRAPHQL(steamAccountIds) {
    return `
    {
